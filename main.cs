...
class Program {
  public static void Main (string[] args) {
    ...
    var Initial2 = "";
    var Initial3 = "";
    // declaring all variables and int's so they can be used inside and outside of the loop
  ...
  do 
   {
    ...
    Console.WriteLine("");//space in between input and output to make output more readable
